...
## Remove Dependency Confirmation Dialog - Auto-Mirror with Toast
- [x] Remove DependencyConfirmationDialog from Tasks.tsx
- [x] Remove DependencyConfirmationDialog from Projects.tsx
- [x] Call updateBidirectionalDependencies automatically after addDependencies
- [x] Show toast notification explaining what was mirrored
- [x] Toast format: "Nachdem A die Folgeaufgabe für B ist, wurde B auch zur Voraussetzung für A"
