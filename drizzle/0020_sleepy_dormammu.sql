...
ALTER TABLE `task_rotation_schedule` ADD CONSTRAINT `task_rotation_schedule_memberId_household_members_id_fk` FOREIGN KEY (`memberId`) REFERENCES `household_members`(`id`) ON DELETE cascade ON UPDATE no action;