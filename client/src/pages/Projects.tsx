      ...
      <div className="container py-6 max-w-4xl">
        ...
        <Card className="shadow-sm">
          <CardContent className="py-16 text-center">
            ...
            <h3 className="text-lg font-semibold mb-2">Projektmanagement</h3>
            <p className="text-muted-foreground max-w-md mx-auto">
              Hier können Sie gemeinsame Projekte planen, Aufgaben mit Abhängigkeiten erstellen
              und mit anderen Haushalten zusammenarbeiten.
            </p>
          </CardContent>
        </Card>
      </div>
