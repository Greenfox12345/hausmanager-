...
PROJECT_PHASES = {
    ...
    "zh": {
        "title": "项目阶段", "description": "任务可以分配给阶段。尚未开始的阶段会淡化显示，其任务暂不会出现在任务列表中。", "add": "阶段", "newName": "新阶段", "empty": "没有阶段时，项目任务会像以前一样立即显示。", "color": "阶段颜色", "name": "阶段名称", "taskPhase": "项目阶段", "unphased": "无阶段——立即显示", "pending": "尚未开始", "taskPhaseHint": "尚未开始的阶段中的任务会在该阶段开始后才出现在任务列表中。", "moveUp": "上移", "moveDown": "下移",
    },
    "ar": {
        "title": "مراحل المشروع", "description": "يمكن إسناد المهام إلى مرحلة. تبقى المراحل التي لم تبدأ باهتة ولا تظهر مهامها في قائمة المهام بعد.", "add": "مرحلة", "newName": "مرحلة جديدة", "empty": "من دون مراحل، تبقى مهام المشروع ظاهرة فوراً كما كانت.", "color": "لون المرحلة", "name": "اسم المرحلة", "taskPhase": "مرحلة المشروع", "unphased": "بلا مرحلة — تظهر فوراً", "pending": "لم تبدأ بعد", "taskPhaseHint": "لا تظهر مهام المرحلة التي لم تبدأ في قائمة المهام إلا بعد بدء المرحلة.", "moveUp": "نقل للأعلى", "moveDown": "نقل للأسفل",
    },
}
